...
//initParticles(); //agregado
//console.log(particleArray); //agregado

function animateParticles() {
    pantalla1.clearRect(0, 0, 300, 300);
    for (var i = 0; i < particleArray.length; i++) {
        particleArray[i].update(mouse);
        particleArray[i].draw(mouse); //agregue parameto mouse
    }
    requestAnimationFrame(animateParticles);
}
//iNICIO MANIPULACION DE CODIGO
/*ctx.lineWidth = 3;
var event
const mouse = {
    x: null,
...
//FINALIZO MANIPULACION DE CODIGO
